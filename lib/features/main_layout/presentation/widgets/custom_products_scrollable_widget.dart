...
import 'package:markti/core/widget/custom_elevated_button.dart';
...
class CustomProductsScrollableWidget extends StatefulWidget {
  ...
  @override
  State<CustomProductsScrollableWidget> createState() =>
      _CustomProductsScrollableWidgetState();
}

class _CustomProductsScrollableWidgetState
    extends State<CustomProductsScrollableWidget> {
