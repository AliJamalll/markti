      ...
      children: [
        ...
        Container(
          ...
          child: TextFormField(
            ...
            obscuringCharacter: '*',
            cursorColor: widget.cursorColor ?? appColors.KPgray,
            onTap: widget.onTap,
            onEditingComplete: () {
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: widget.isObscured
                  ? IconButton(
                      ...
                      selectedIcon: const Icon(Icons.remove_red_eye_rounded,color: Colors.grey,),
                      icon: Icon(Icons.visibility_off,color: appColors.KPgray,),
                    )
                  : widget.suffixIcon,
