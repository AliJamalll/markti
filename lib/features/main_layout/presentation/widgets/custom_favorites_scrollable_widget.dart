...
class customFavoriteScrollableWidget extends StatefulWidget {
  customFavoriteScrollableWidget({super.key,});

  @override
  State<customFavoriteScrollableWidget> createState() => _CustomProductsScrollableWidgetState();
}

class _CustomProductsScrollableWidgetState extends State<customFavoriteScrollableWidget> {
