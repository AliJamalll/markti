...
import 'package:markti/features/main_layout/data/models/add_to_cart_response_DM.dart';
import 'package:markti/features/main_layout/data/models/brand_response_DM.dart';
import 'package:markti/features/main_layout/data/models/category_response_DM.dart';
...
class MainLayoutRemoteDataSourceImpl implements MainLayoutRemoteDateSource{
  ...
  @override
  Future<Either<Failure, CategoryResponseDm>> getAllCategories()async {
    try {
      final List<ConnectivityResult> connectivityResult = await Connectivity().checkConnectivity();
      if(connectivityResult.contains(ConnectivityResult.mobile) || connectivityResult.contains(ConnectivityResult.wifi)){
  ...
  @override
  Future<Either<Failure, AddToCartResponseDm>> addToCart(String productId) async{
    try{
      final List<ConnectivityResult> connectivityResult = await Connectivity().checkConnectivity();
      if(connectivityResult.contains(ConnectivityResult.wifi) || connectivityResult.contains(ConnectivityResult.mobile)){
        var response = await apiManager.postData(endPoint: EndPoints.addToCart,
            data: {
              "productId" : productId,
            },
            headers: {
